...
function portfolioItemDetails(portfolioItem) {
    ...
    document.querySelector(".portfolio__popup-subtitle span").innerHTML = portfolioItem.querySelector(".term").innerHTML;
    document.querySelector(".details__title").innerHTML = portfolioItem.querySelector(".portfolio-item-title").innerHTML;
